...
data_source_cfg = dict(
    ...
    memcached=True,
    mclient_path='/mnt/lustre/share/memcached_client')
data_train_list = '/media/zahid/Data/openselfsup/data/VOCdevkit/VOC2007/Lists/trainvaltest.txt'
data_train_root = '/media/zahid/Data/openselfsup/data/VOCdevkit/VOC2007/JPEGImages'
##########################################################################
